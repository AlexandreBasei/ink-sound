...
public class PlayerMovement : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		_inputActions.Player.Jump.started += ctx => OnJumpInput();
		_inputActions.Player.Jump.canceled += ctx => OnJumpUpInput();

		_inputActions.Player.Dash.started += ctx => OnDashInput();
	}
